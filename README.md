...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/604108c1ae06af001891fedd
...
To start editing your site, you can use the Sanity interface at https://pink-potato-108c1.sanity.studio/.
...
Generated at `2021-03-04T16:20:35.479Z` by Stackbit version `0.3.50`.